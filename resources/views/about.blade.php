...
@section('content')
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url({{asset('img/slide-2.jpeg')}});" >
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                @foreach ($teams as $tmitem)
                     <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="rounded shadow shadow1 overflow-hidden">
                        <div class="position-relative">
                            <img class="img-fluid team-img" src="{{asset($tmitem->image)}}" alt="{{$tmitem->name}}">
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0">{{$tmitem->name}}</h5>
                            <small>{{$tmitem->position}}</small>
                        </div>
                    </div>
                </div>
                @endforeach
